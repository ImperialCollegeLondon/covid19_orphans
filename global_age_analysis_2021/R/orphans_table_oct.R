...
saveRDS(df, file = "global_age_analysis_2021/orphans.RDS")
...
# write.csv(tab_1, file = "global_age_analysis_2021/orphans_tab1.csv", row.names=FALSE)
# 
# # Table 2
...
# write.csv(tab_2, file = "global_age_analysis_2021/orphans_tab2.csv", row.names=FALSE)