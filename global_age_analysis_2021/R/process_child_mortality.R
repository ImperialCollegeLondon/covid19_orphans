...
add_child_mortality = function(is_child_mortality_needed, country, uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    children = read.csv(paste0('global_age_analysis_2021/data/', country, '/child_raw_m.csv'))
    ...
    if (is_child_mortality_needed){
      ...
      child_m_matrix = read.csv(paste0('global_age_analysis_2021/data/', country, '/child_mortality_rate.csv'))
    ...
    children = read.csv(paste0('global_age_analysis_2021/data/', country, '/child_raw_m_un.csv'))
    plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
    plot_c$father_age = rep(1:100,18)
    plot_c$child_age =sort(rep(seq(18)-1, 100))
    setnames(plot_c, 1, 'prob')
...
#   data = readxl::read_xlsx('global_age_analysis_2021/data/NumberDeaths.xlsx', sheet = 2)
...
#   data_pop = readxl::read_xlsx('global_age_analysis_2021/data/fertility_update/pop.xlsx', sheet = 2)
...
process_child_mortality = function(country, countries){
  # rate per children 
  if (country != "Russia"){
    child = read.csv(paste0('global_age_analysis_2021/data/child_mortality_rate', '.csv'))
    child = child %>% filter(country == countries)
    
  }else{
    child = read.csv('global_age_analysis_2021/data/Russia/mortality_rate_all.csv')
  }
...
process_children_mortality_england_wales = function(){
  ...
  #download.file(url, 'global_age_analysis_2021/data/children/mortality_england_wales.xls')
  data = readxl::read_xls('global_age_analysis_2021/data/UK/mortality_england_wales.xls', sheet = 5)
  ...
  # saveRDS(pop,"global_age_analysis_2021/data/UK/pop_child_mortality.RDS")
  
  pop  = readRDS("global_age_analysis_2021/data/UK/pop_child_mortality.RDS")
...
process_infant_mortality_england_wales = function(){
  ...
  #download.file(url, 'global_age_analysis_2021/data/UK/infant_england_wales.csv')
  data = read.csv('global_age_analysis_2021/data/UK/infant_england_wales.csv')
  data  = data[7:nrow(data),]
  names(data) = c('year', 'mortality')
  data$age = '0 year'
  child_m = read.csv('global_age_analysis_2021/data/UK/mortality_rate_england_wales.csv')
...
process_child_mortality_england_wales = function(){
  ...
  child = read.csv('global_age_analysis_2021/data/UK/mortality_rate_all_england_wales.csv')
...
process_child_mortality_russia = function(){
  data_04 = read.csv('global_age_analysis_2021/data/Russia/russian_federation_0-4.csv')
  data_04 = data_04[,c(1,4:5)]
  setnames(data_04, 1:3, c('country', 'year', 'mortality'))
  data_04$age = '0-4'  
  data_59 = read.csv('global_age_analysis_2021/data/Russia/russian_federation_5-9.csv')
  data_59 = data_59[,c(1,4:5)]
  setnames(data_59, 1:3, c('country', 'year', 'mortality'))
  data_59$age = '5-9'  
  data_1014 = read.csv('global_age_analysis_2021/data/Russia/russian_federation_10-14.csv')
  data_1014 = data_1014[,c(1,4:5)]
  setnames(data_1014, 1:3, c('country', 'year', 'mortality'))
  data_1014$age = '10-14'  
  data_1519 = read.csv('global_age_analysis_2021/data/Russia/russian_federation_15-19.csv')
