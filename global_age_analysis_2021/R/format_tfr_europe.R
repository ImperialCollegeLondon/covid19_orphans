...
format_tfr_europe_excess <- function(orphans_path, deaths_path){
  # Reads in orphans
  orphans_path = "global_age_analysis_2021/orphans.RDS"
  orphans = data.frame(readRDS(orphans_path))
  orphans$country = row.names(orphans)
  orphans$country[which(orphans$country == "USA")] = "US"
  ...
  # Reads in deaths
  excess_deaths = excess = readRDS("global_age_analysis_2021/data/exces_deaths.RDS")
  ...
  saveRDS(joined, "global_age_analysis_2021/data/tfr_covariates_excess.RDS")
