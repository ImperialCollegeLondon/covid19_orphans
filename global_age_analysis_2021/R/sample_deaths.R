...
sample_deaths_argentina <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Argentina/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_brazil <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Brazil/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_colombia <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Colombia/covid19_deaths_all', month, '_un.csv'))
}
...
sample_deaths_england_wales <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/UK/deaths_all_england_wales', month, '_un.csv'))
}
...
sample_deaths_france <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/France/france_all', month, '_un.csv'))
}
...
sample_deaths_germany <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Germany/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_india <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/India/all_covid_deaths', month, '_un.csv'))
}
...
sample_deaths_iran <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Iran/iran_all', month, '_un.csv'))
}
...
sample_deaths_italy <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Italy/italy_all', month, '_un.csv'))
}
...
sample_deaths_kenya <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Kenya/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_malawi <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Malawi/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_mexico <- function(month = ""){
  ...
  d_merge$deaths <- rpois(length(d_merge$deaths), d_merge$deaths)
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Mexico/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_peru <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Peru/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_philippines <- function(month = ""){
  ...
  d_merge$COVID19_deaths <- rpois(length(d_merge$COVID19_deaths), d_merge$COVID19_deaths)
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Philippines/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_poland <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Poland/poland_all', month, '_un.csv'))
}
...
sample_deaths_spain <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Spain/spain_all', month, '_un.csv'))
}
...
sample_deaths_south_africa <- function(month = ""){
  ...
  d_merge$COVID19_deaths <- rpois(length(d_merge$COVID19_deaths), d_merge$COVID19_deaths)
  write.csv(d_merge, paste0('global_age_analysis_2021/data/SouthAfrica/covid19_deaths', month, '_un.csv'))
}
...
sample_deaths_usa <- function(month = ""){
  ...
  write.csv(d_merge, paste0('global_age_analysis_2021/data/USA/usa_all', month, '_un.csv'))
}
...
sample_deaths_zimbabwe <- function(month = ""){
  ...
  d_merge$deaths <- rpois(length(d_merge$deaths), d_merge$deaths)
  write.csv(d_merge, paste0('global_age_analysis_2021/data/Zimbabwe/covid19_deaths', month, '_un.csv'))
}
