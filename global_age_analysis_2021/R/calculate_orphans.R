...
process_orphans_argentina = function(month = ""){
  ...
  country = 'colombia'
  d_children = read.csv(paste0('global_age_analysis_2021/data/Colombia/','children.csv'), stringsAsFactors = FALSE)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/Argentina/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_argentina.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/Argentina/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_brazil = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/Brazil/children.csv'), stringsAsFactors = FALSE)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/Brazil/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_brazil.pdf", p, width = 6, height = 5)
  d_summary = d_m1 %>% select(age, gender, deaths, orphans)
  ...
  write.csv(file = 'global_age_analysis_2021/data/Brazil/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_colombia = function(month = ""){
  ...
  d_m1 = d_m1%>% arrange(age)                  
  write.csv(file = paste0('global_age_analysis_2021/data/Colombia/orphans_all.csv'), d_m1, row.names=FALSE)
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    geom_bar(stat="identity", position=position_dodge()) +
    theme_bw()+
    theme(axis.text.x = element_text(angle = 30, hjust = 1, vjust = 1))+
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_colombia.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/Colombia/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_england_wales = function(month = ""){
  ...
  d_children = read.csv('global_age_analysis_2021/data/UK/children.csv', stringsAsFactors = FALSE)
  d_children$age = paste0(d_children$age%/%5 * 5,'-',d_children$age %/% 5 *5+4)
  ...
  write.csv(file = 'global_age_analysis_2021/data/UK/england_wales_orphans_all.csv', d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_england_wales.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/UK/england_wales_all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_france = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/France/children.csv'), stringsAsFactors = FALSE)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/France/france_orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_france.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/France/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_germany = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/Germany/children.csv'))
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('90-99', '100-109'), '90+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  #d_m1$age = ifelse(d_m1$age == '100+', '99+', d_m1$age)
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Germany/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_germany.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/Germany/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_india = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/India/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0(d_children$age%/%5 * 5,'-',d_children$age %/% 5 *5+4)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/India/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = sex)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_india.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, sex) %>% 
    summarise(covid_deaths = as.integer(round(sum(deaths))),
           nb_orphans = as.integer(round( sum(orphans)))) %>%
    arrange(age)
  write.csv(file = 'global_age_analysis_2021/data/India/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% 
    group_by(sex) %>% 
...
process_orphans_iran = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/Iran/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  ...
  d_m1[, orphans := round(deaths * nb_c)]
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Iran/iran_orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_iran.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise(max_deaths = as.integer(round((sum(deaths)))),
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Iran/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
...
process_orphans_italy = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/Italy/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('90-99', '100-109'), '90+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  d_m1[, orphans := round(deaths * nb_c)]
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Italy/italy_orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_italy.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise(nb_excess = round(sum(excess_deaths)),
           ...
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Italy/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
...
process_orphans_kenya = function(month = ""){
  country = 'kenya'
  d_deaths = read.csv(paste0('global_age_analysis_2021/data/Kenya/covid19_deaths', month, '.csv'), stringsAsFactors = FALSE)
  d_merge = copy(d_deaths)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Kenya/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  ...
  d_m1$age = as.character(d_m1$age)
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Kenya/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_kenya.pdf", p, width = 6, height = 5)
  d_summary = d_m1 %>% select(age, gender, deaths, orphans)
  d_summary$age = as.character(d_summary$age)
  ...
  write.csv(file = 'global_age_analysis_2021/data/Kenya/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
    summarise(covid19 = round(sum(COVID19_deaths)),
              orphans= round( sum( nb_orphans))) 
}
...
process_orphans_malawi = function(month = ""){
  country = 'malawi'
  d_deaths = read.csv(paste0('global_age_analysis_2021/data/Malawi/covid19_deaths', month, '.csv'), stringsAsFactors = FALSE)
  d_merge = copy(d_deaths)
  d_merge$age = as.character(d_merge$age)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Malawi/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  ...
  d_m1$age = as.character(d_m1$age)
  d_m1 = d_m1%>% arrange(age)
  write.csv(file = paste0('global_age_analysis_2021/data/Malawi/orphans_all.csv'), d_m1, row.names=FALSE)
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    geom_bar(stat="identity", position=position_dodge()) +
    theme_bw()+
    theme(axis.text.x = element_text(angle = 30, hjust = 1, vjust = 1))+
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_malawi.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>%
    summarise( COVID19_deaths = as.integer(round(sum(deaths))),
            nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Malawi/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>%
    summarise(covid19 = round(sum(COVID19_deaths)),
           orphans= round( sum( nb_orphans)))
}
...
process_orphans_mexico = function(month = ""){
  ...
  d_merge = copy(d_deaths)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Mexico/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0(d_children$age%/%5 * 5,'-',d_children$age %/% 5 *5+4)
  d_children$age = ifelse(d_children$age %in% c('80-84', '85-89','90-94', '95-99', '100-104'), '80+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  d_m1$age = ifelse(d_m1$age == '0-4', '00-04', 
                    ifelse(d_m1$age == '5-9','05-09' ,d_m1$age))
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Mexico/', country,'_orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_mexico.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise( COVID19_deaths = as.integer(round(sum(deaths))),
            nb_orphans = as.integer(round(sum(orphans)))) 
  write.csv(file = 'global_age_analysis_2021/data/Mexico/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_nigeria = function(month = ""){
  country = 'nigeria'
  d_deaths = read.csv(paste0('global_age_analysis_2021/data/Nigeria/covid19_deaths', month, '.csv'), stringsAsFactors = FALSE)
  d_deaths$age[d_deaths$age == "05-Sep"] <- "5-9"
  d_deaths$age[d_deaths$age == "Oct-14"] <- "10-14"
  d_merge = copy(d_deaths)
  d_merge$age = as.character(d_merge$age)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Nigeria/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%5 * 5 ,'-',(d_children$age) %/% 5 *5+4)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/Nigeria/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_nigeria.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise( COVID19_deaths = as.integer(round(sum(deaths))),
            nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Nigeria/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
    summarise(covid19 = round(sum(COVID19_deaths)),
           orphans= round( sum( nb_orphans)))
}
...
process_orphans_peru = function(month = ""){
  country = 'peru'
  d_deaths = read.csv(paste0('global_age_analysis_2021/data/Peru/covid19_deaths', month, '.csv'), stringsAsFactors = FALSE)
  d_deaths$age[d_deaths$age == "Oct-19"] <- "10-19"
  setnames(d_deaths, 'COVID19_deaths','deaths')
  d_merge = copy(d_deaths)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Peru/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('90-99','100-109'), '90+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  write.csv(file = paste0('global_age_analysis_2021/data/Peru/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_peru.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise( COVID19_deaths = as.integer(round(sum(deaths))),
            nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Peru/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
    summarise(covid19 = round(sum(COVID19_deaths)),
           orphans= round( sum( nb_orphans)))
}
...
process_orphans_philippines= function(month = ""){
  ...
  d_merge = copy(d_deaths)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Philippines/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%5 * 5 ,'-',(d_children$age) %/% 5 *5+4)
  ...
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Philippines/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_philippines.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise(max_deaths = as.integer(round((sum(COVID19_deaths)))),
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Philippines/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-14') %>% group_by(gender) %>% 
    summarise(total_deaths= round(sum(max_deaths)),
           orphans= round( sum( nb_orphans)))
}
...
process_orphans_poland = function(month = ""){
  ...
  d_merge = copy(d_deaths)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Poland/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('90-99', '100-109'), '90+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Poland/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_poland.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise(max_deaths = as.integer(round((sum(death)))),
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Poland/all_data.csv', d_summary, row.names=FALSE)
  d_summary %>% filter(age != '0-19') %>% group_by(gender) %>% 
    summarise(total_deaths= round(sum(max_deaths)),
           orphans= round( sum( nb_orphans)))
}
...
process_orphans_russia = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/Russia/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%5 * 5 ,'-',(d_children$age) %/% 5 *5+4)
  ...
  d_m1$age = factor(d_m1$age, levels = c("0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39",  "40-44", "45-49",
                                         ...
                                         "95-99", "100+"))
  d_m1 <- d_m1 %>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Russia/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = sex)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_russia.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, sex) %>% 
    summarise(max_deaths = as.integer(round((sum(deaths)))),
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Russia/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_spain = function(month = ""){
  ...
  d_merge = d_deaths
  d_children = read.csv(paste0('global_age_analysis_2021/data/Spain/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0((d_children$age)%/%10 * 10 ,'-',(d_children$age) %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('80-89', '90-99','100-109'), '80+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  d_m1[, orphans := round(deaths * nb_c)]
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Spain/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_spain.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise(nb_excess = round(sum(excess_deaths)),
           ...
           max_deaths = as.integer(round((sum(deaths)))),
           nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Spain/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_south_africa = function(month = ""){
  ...
  d_merge$age = as.character(d_merge$age)
  setnames(d_merge, 'COVID19_deaths', 'deaths')
  d_children = read.csv(paste0('global_age_analysis_2021/data/SouthAfrica/children.csv'), stringsAsFactors = FALSE)
  d_children$age = paste0(d_children$age%/%10 * 10,'-',d_children$age %/% 10 *10+9)
  d_children$age = ifelse(d_children$age %in% c('80-89', '90-99', '100-109'), '80+', d_children$age)
  d_children = d_children %>% group_by(age, gender) %>% summarise(nb_c = mean(children))
  d_merge$gender = as.character(d_merge$gender)
  ...
  d_m1$age = as.character(d_m1$age)
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/SouthAfrica/orphans_all.csv'), d_m1, row.names=FALSE)
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    geom_bar(stat="identity", position=position_dodge()) +
    theme_bw()+
    theme(axis.text.x = element_text(angle = 30, hjust = 1, vjust = 1))+
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_south_africa.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/SouthAfrica/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_usa = function(month = ""){
  ...
  d_children = read.csv(paste0('global_age_analysis_2021/data/USA/children.csv'), stringsAsFactors = FALSE)
  ...
  d_m1[, orphans := round(deaths * nb_c)]
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/USA/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_usa.pdf", p, width = 6, height = 5)
  ...
  write.csv(file = 'global_age_analysis_2021/data/USA/all_data.csv', d_summary, row.names=FALSE)
...
process_orphans_zimbabwe = function(month = ""){
  country = 'zimbabwe'
  d_deaths = read.csv(paste0('global_age_analysis_2021/data/Zimbabwe/covid19_deaths', month, '.csv'), stringsAsFactors = FALSE)
  d_merge = copy(d_deaths)
  d_merge$age = as.character(d_merge$age)
  d_children = read.csv(paste0('global_age_analysis_2021/data/Zimbabwe/children.csv'), stringsAsFactors = FALSE)
  ...
  d_m1$age = as.character(d_m1$age)
  d_m1 = d_m1%>% arrange(age) 
  write.csv(file = paste0('global_age_analysis_2021/data/Zimbabwe/orphans_all.csv'), d_m1, row.names=FALSE)
  ...
  p <- ggplot(d_m1, aes(x = age, y = orphans, fill = gender)) +
    ...
    ylab('Number of Orphans')+
    guides(fill=guide_legend(title="Sex of Parent"))
  ggsave(filename = "global_age_analysis_2021/figures/orphans_all_age_zimbabwe.pdf", p, width = 6, height = 5)
  ...
  d_summary = d_summary %>% group_by(age, gender) %>% 
    summarise( COVID19_deaths = as.integer(round(sum(deaths))),
            nb_orphans = as.integer(round(sum(orphans))))
  write.csv(file = 'global_age_analysis_2021/data/Zimbabwe/all_data.csv', d_summary, row.names=FALSE)
