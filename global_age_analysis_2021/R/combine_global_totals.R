...
parents = readRDS("global_age_analysis_2021/data/age_outputs/reg_pa.RDS")
...
primary = readRDS("global_age_analysis_2021/data/age_outputs/reg_p.RDS")
...
primary_secondary = readRDS("global_age_analysis_2021/data/age_outputs/reg_ps.RDS")
