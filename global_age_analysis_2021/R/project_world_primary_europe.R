...
saveRDS(ratio_dat, "global_age_analysis_2021/data/primary_ratios.RDS")
...
saveRDS(orphans_samples_swapped, "global_age_analysis_2021/data/p_total_samples.RDS")
...
saveRDS(orphanhood_country, "global_age_analysis_2021/data/p_samples.RDS")
...
saveRDS(reg_samples_, "global_age_analysis_2021/data/age_outputs/reg_p_samples.RDS")
