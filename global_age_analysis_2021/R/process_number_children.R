...
process_number_children_brazil <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Brazil/brazil_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Brazil/brazil_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Brazil/brazil_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Brazil/brazil_fertility_f_un.csv'))
  }
...
process_number_children_colombia <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Colombia/colombia_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Colombia/colombia_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Colombia/colombia_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Colombia/colombia_fertility_f_un.csv'))
  }
...
process_number_children_india <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/India/india_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/India/india_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/India/india_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/India/india_fertility_f_un.csv'))
  }
...
process_number_children_kenya <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Kenya/kenya_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Kenya/kenya_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Kenya/kenya_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Kenya/kenya_fertility_f_un.csv'))
  }
...
process_number_children_malawi <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Malawi/malawi_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Malawi/malawi_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Malawi/malawi_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Malawi/malawi_fertility_f_un.csv'))
  }
...
process_number_children_nigeria <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Nigeria/nigeria_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Nigeria/nigeria_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Nigeria/nigeria_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Nigeria/nigeria_fertility_f_un.csv'))
  }
  is_child_mortality_needed = 0
...
process_number_children_peru <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Peru/peru_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Peru/peru_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Peru/peru_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Peru/peru_fertility_f_un.csv'))
  }
  is_child_mortality_needed = 0
...
process_number_children_south_africa <- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/SouthAfrica/southafrica_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/SouthAfrica/southafrica_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/SouthAfrica/southafrica_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/SouthAfrica/southafrica_fertility_f_un.csv'))
  }
  is_child_mortality_needed = 0
...
process_number_children_zimbabwe<- function(uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Zimbabwe/zimbabwe_fertility_m_all.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Zimbabwe/zimbabwe_fertility_m_all_un.csv'))
  }
  ...
  if (uncertainty == FALSE){
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Zimbabwe/zimbabwe_fertility_f.csv'))
  } else {
    write_csv(data_f, path = paste0('global_age_analysis_2021/data/Zimbabwe/zimbabwe_fertility_f_un.csv'))
  }
  is_child_mortality_needed = 0
