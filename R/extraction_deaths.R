...
process_argentina_covid19 = function(){
  data = read.csv('data/Argentina/Argentina - Deaths by age and sex (rates per 100,000)-apr.csv')
  ...
  deaths_data = read.csv("data/04-30-2021.csv")
...
process_france = function(){
  tmp = readxl::read_xlsx('data/France/Deaths-Age-Sex_Covid-19_France_06-05.xlsx', sheet = 2)
...
process_germany = function(){
  tmp = readxl::read_xlsx('data/Germany/Deaths-Age-Sex_Covid-19_Germany_06-05.xlsx', sheet = 2)
...
process_italy = function(){
  tmp = readxl::read_xlsx('data/Italy/Deaths-Age-Sex_Covid-19_Italy_06-05.xlsx', sheet = 2)
...
process_mexico_covid19 = function(){
  data = read.csv('data/Mexico/Mexico - Deaths by age and sex (rates per 100,000)-apr.csv', fileEncoding="latin1")
...
process_nigeria_covid19 = function(){
  d_merge = read.csv('data/Nigeria/covid19_deaths_raw_apr.csv')
...
process_spain = function(){
  tmp = readxl::read_xlsx('data/Spain/Deaths-Age-Sex_Covid-19_Spain_06-05.xlsx', sheet = 6)
...
process_sa_covid19 = function(){
  d_merge = read.csv('data/SouthAfrica/covid19_deaths_raw_apr.csv')
...
process_usa = function(){
  tmp = readxl::read_xlsx('data/USA/Deaths-Age-Sex_Covid-19_USA_06.05.xlsx', sheet = 2)
  data = tmp[7:16, c(1,c(15, 17, 20))]
  data = data.frame(data)
  names(data) = c('age', 'male', 'female', 'both')
  data$male = as.numeric(data$male)
  ...
  #download.file(url, 'data/USA/usa_excess_mortality_all_apr.csv')
  data = read.csv('data/USA/usa_excess_mortality_all_apr.csv')
