...
for (y in 1:4){
  ...
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/ng_mothers_18.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/ng_mothers_13.RDS")
  } else if (y == 3){
    all_data <- readRDS("data/DHS/ng_mothers_08.RDS")
  } else {
    all_data <- readRDS("data/DHS/ng_mothers_03.RDS")
  }
...
saveRDS(df_fertility, file = "data/Nigeria/female_fertility.RDS")
