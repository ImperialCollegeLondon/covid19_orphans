...
for (y in 1:3){
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/ug_mothers_16.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/ug_mothers_11.RDS")
  } else {
    all_data <- readRDS("data/DHS/ug_mothers_06.RDS")
  }
