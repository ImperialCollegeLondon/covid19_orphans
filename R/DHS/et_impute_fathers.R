...
for (y in 1:3){
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/et_fathers_16.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/et_fathers_11.RDS")
  } else {
    all_data <- readRDS("data/DHS/et_fathers_05.RDS")
  }
...
saveRDS(df_fertility, file = "data/Ethiopia/male_fertility.RDS")
