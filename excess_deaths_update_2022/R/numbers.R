...
top5$format = sprintf("%s [%s - %s]", 
                      format(round(top5$primary_secondary, -4), big.mark = ",", trim = TRUE), 
                      format(round.choose(top5$ps_lower, 10000, 0), big.mark = ",", trim = TRUE), 
                      format(round.choose(top5$ps_upper, 10000, 1), big.mark = ",", trim = TRUE))
...
top5_africa$format = sprintf("%s [%s - %s]", 
                      format(round(top5_africa$primary_secondary, -4), big.mark = ",", trim = TRUE), 
                      format(round.choose(top5_africa$ps_lower, 10000, 0), big.mark = ",", trim = TRUE), 
                      format(round.choose(top5_africa$ps_upper, 10000, 1), big.mark = ",", trim = TRUE))
...
top5_sea$format = sprintf("%s [%s - %s]", 
                             format(round(top5_sea$primary_secondary, -4), big.mark = ",", trim = TRUE), 
                             format(round.choose(top5_sea$ps_lower, 10000, 0), big.mark = ",", trim = TRUE), 
                             format(round.choose(top5_sea$ps_upper, 10000, 1), big.mark = ",", trim = TRUE))
