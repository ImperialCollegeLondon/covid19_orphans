...
args <- list( 
	source_dir= '~/Documents/GitHub/covid19_orphans',
	rep=0
)
...
source(file.path("R","us_states","extraction_excess.R"))
source(file.path("R","us_states","process_fertility.R"))
source(file.path("R","us_states","process_number_children.R"))
source(file.path("R","us_states","calculate_orphans.R"))
source(file.path("R","us_states","process_skip_generation.R"))
source(file.path("R","us_states","summary_orphans.R"))
...
source(file.path("R","us_states","make-manuscript-figures.R"))
source(file.path("R","us_states","make-manuscript-tables.R"))
source(file.path("R","us_states","SM_figures_tables.R"))
