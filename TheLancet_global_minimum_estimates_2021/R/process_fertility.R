...
process_fertility_plots = function(country){
  if (country == 'england_wales'){
    data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_all.csv')
    ...
    data_father = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/', tolower(country), '_fertility_m_all.csv'))
    data_mother = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/', tolower(country), '_fertility_f.csv'))
  ...
  ggsave(paste0("TheLancet_global_minimum_estimates_2021/figures/fertility_", tolower(country), ".pdf"), width = 10, height = 4)
}

# Process fertility data
process_fertility_all_countries = function(){
  all_combine = NaN
  list_file = list.files('TheLancet_global_minimum_estimates_2021/data/fertility_update', '.json')
  ...
  for (name_file in list_file)
  {
    ...
    json_data = suppressWarnings(fromJSON(paste(readLines(paste0('TheLancet_global_minimum_estimates_2021/data/fertility_update/',name_file)))))
    data = as.data.table(unlist(json_data))
    data$country = names(json_data)
    setnames(data, 1, 'idx')
    dataset = readxl::read_xls(paste0('TheLancet_global_minimum_estimates_2021/data/fertility_update/', strsplit(name_file, '.json')[[1]][1],'.xls'), sheet = 1)
  ...
  write_csv(path = "TheLancet_global_minimum_estimates_2021/data/fertility_update/parents_live_births.csv", all_combine)
}
...
process_england_wales_fertility = function(){
  ...
  #download.file(url, 'TheLancet_global_minimum_estimates_2021/data/fertility/england_wales_births.xls')
  data = readxl::read_xls('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_births.xls', sheet = 11)
  ...
  ##  per 1000 men
  write_csv(data_all, file = 'TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_m.csv')
  
  # female
  # url = 'https://www.ons.gov.uk/file?uri=%2fpeoplepopulationandcommunity%2fbirthsdeathsandmarriages%2flivebirths%2fdatasets%2fbirthsbyparentscharacteristics%2f2018/parentscharacteristics2018workbook.xls'
  #download.file(url, 'TheLancet_global_minimum_estimates_2021/data/fertility/england_wales_births.xls')
  data = readxl::read_xls('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_births.xls', sheet = 5)
  d_name = as.character(data[6,])
  d_name[1:2] = c('year', 'ignore')
  data = data[7:nrow(data),]
  names(data) = d_name
  ...
  write_csv(data, file = 'TheLancet_global_minimum_estimates_2021/data/UK/england_births_f.csv')
  ...
  write_csv(d_data, path = 'TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_f.csv')
  
  d_fertility_m = read.csv('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_m.csv')
  d_all = rbind(d_data %>% select(-pop_nb, -value), d_fertility_m)
  write_csv(d_all, path = 'TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_all.csv')
}

# France
process_france_fertility = function(){
  data_fertility = read.csv('TheLancet_global_minimum_estimates_2021/data/fertility/unsd_live_births.csv')
  data_fertility = data_fertility %>% filter(country == 'France',
                                             age != 'Unknown - Inconnu',
                                             gender == 'Male')
  
  data_pop = readxl::read_xlsx('TheLancet_global_minimum_estimates_2021/data/pop.xlsx', sheet = 2)
  countries = c('France')
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/France/fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/France/fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/France/france_fertility_m_all.csv', data_combine)
  ...
  #download.file(url, 'TheLancet_global_minimum_estimates_2021/data/afr.zip')
  #data = fread(unzip('TheLancet_global_minimum_estimates_2021/data/afr.zip', files = 'IHME_GBD_2019_FERTILITY_1950_2019_ASFR_Y2020M10D27.CSV'))
  data = read.csv("TheLancet_global_minimum_estimates_2021/data/IHME_GBD_2019_FERTILITY_1950_2019_ASFR_Y2020M10D27.CSV")
  ...
  write_csv(file = 'TheLancet_global_minimum_estimates_2021/data/France/france_fertility_f_ihme.csv', d_rate_ihme)
  
  # from WPP
  data = read_excel("TheLancet_global_minimum_estimates_2021/data/WPP2019_FERT_F07_AGE_SPECIFIC_FERTILITY.xlsx")
  names(data) <- data[12,]
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/France/france_fertility_f.csv', d_wpp_long_rep)
}
...
compare_fertility_france = function(){
  ...
  data_combine_f = read.csv('TheLancet_global_minimum_estimates_2021/data/France/france_fertility_f.csv')
  data_combine_f = data_combine_f %>% select(date, age, fertility_rate)
  data_combine_f$source = 'UNWPP'
  setnames(data_combine_f, 'date', 'year')
  
  data_combine_f_ihme = read.csv('TheLancet_global_minimum_estimates_2021/data/France/france_fertility_f_ihme.csv')
  ...
  ggsave("TheLancet_global_minimum_estimates_2021/figures/compare_fertility_france.pdf", width = 7, height = 5)
}
...
process_germany_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_m.csv', data_combine)
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_f.csv', d_wpp_long_rep)
}
...
process_iran_fertility = function(){
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Iran/iran_fertility_f.csv', d_wpp_long_rep)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Iran/iran_fertility_m_all.csv', m_iran)
...
process_italy_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_f.csv', d_wpp_long_rep)
}
...
process_mexico_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(file = 'TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_f.csv', d_wpp_long_rep)
}

process_philippines_fertility = function(){
  data_fertility = read.csv('TheLancet_global_minimum_estimates_2021/data/fertility/unsd_live_births.csv', stringsAsFactors = FALSE)
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(file = 'TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_f.csv', d_wpp_long_rep)
}
...
process_poland_fertility = function(){
  ...
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Poland/poland_fertility_m.csv', data_combine)
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Poland/poland_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Poland/poland_fertility_f.csv', d_wpp_long_rep)
}
...
process_russia_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_f.csv', d_wpp_long_rep)
}
...
process_spain_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_f.csv', d_wpp_long_rep)
}
...
process_usa_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_m.csv', data_combine)
  
  data_combine = read.csv('TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_m_all.csv', data_combine)
  ...
  write_csv(path = 'TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_f.csv', d_wpp_long_rep)
}
