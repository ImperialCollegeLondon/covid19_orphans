...
source("TheLancet_global_minimum_estimates_2021/R/shiny_table.R")

d <- read.csv("TheLancet_global_minimum_estimates_2021/data/time_series_covid19_deaths_global.csv")
...
print(p)
ggsave("TheLancet_global_minimum_estimates_2021/figures/time_series_line.pdf", p, width =  10,  height = 6)
