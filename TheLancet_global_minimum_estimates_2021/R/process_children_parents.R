...
process_children_all = function(country, is_child_mortality_needed, data_f){
  ...
  write_csv(path = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_raw_f.csv'), children)
  ...
  if (is_child_mortality_needed){
    ...
    write_csv(file = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_all_f.csv'), child_and_m)
  ...
  write_csv(file = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_all_list_f.csv'), plot_c_and_m) 
  setnames(plot_c_and_m, 'mother_age', 'parents_age')
  plott = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_all_list_m.csv')) 
  setnames(plott, 'father_age', 'parents_age')
  plot_all = rbind(plot_c_and_m, plott)
  write_csv(file = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_all_list_both_sex.csv'), plot_all) 
  ...
  ddf$gender = 'female'
  ddf$age = 1:100
  write_csv(file = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/children_f.csv'), ddf)
  
  ddf = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/children_f.csv'))
  ddf_2 = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/', country,'/children_m.csv'))
  ddf = rbind(ddf, ddf_2)
  p = ggplot(ddf) +
  ...
  ggsave(filename = paste0("TheLancet_global_minimum_estimates_2021/figures//children_", tolower(country), ".pdf"), p, width = 6, height = 5)
  write_csv(file = paste0('TheLancet_global_minimum_estimates_2021/data/', country,'/children.csv'), ddf)
}
...
process_children_father_england_wales = function(data_f){
  ...
  write_csv(path = paste0('TheLancet_global_minimum_estimates_2021/data/UK/child_raw_m.csv'), children)
  plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
...
process_children_father_80_plus = function(country, data_f){
  ...
  write_csv(path = paste0('TheLancet_global_minimum_estimates_2021/data/', country, '/child_raw_m.csv'), children)
  plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
  plot_c$father_age = rep(1:100,18)
  plot_c$child_age =sort(rep(seq(18)-1, 100))
  setnames(plot_c, 1, 'prob')
...
process_children_father_60_plus = function(country, data_f){
  ...
  write_csv(path = paste0('TheLancet_global_minimum_estimates_2021/data/Russia/child_raw_m.csv'), children)
  plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
  plot_c$father_age = rep(1:100,18)
  plot_c$child_age =sort(rep(seq(18)-1, 100))
  setnames(plot_c, 1, 'prob')
