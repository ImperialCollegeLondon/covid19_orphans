...
remove <- runif(length(mother_data$id_woman), 0, 1)
mother_data$age_mother_now <- ifelse(remove < 0.4, NA, mother_data$age_mother_now)
...
saveRDS(df_fertility, file = "data/Brazil/female_fertility_half.RDS")
