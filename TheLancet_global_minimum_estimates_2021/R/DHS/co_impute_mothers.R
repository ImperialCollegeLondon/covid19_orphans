...
for (y in 1:3){
  ...
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/co_mothers_15.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/co_mothers_10.RDS")
  } else {
    all_data <- readRDS("data/DHS/co_mothers_05.RDS")
  }
...
saveRDS(df_fertility, file = "data/Colombia/female_fertility.RDS")
