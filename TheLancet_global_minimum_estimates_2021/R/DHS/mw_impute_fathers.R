...
for (y in 1:3){
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/mw_fathers_15.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/mw_fathers_10.RDS")
  } else {
    all_data <- readRDS("data/DHS/mw_fathers_04.RDS")
  }
...
saveRDS(df_fertility, file = "data/Malawi/male_fertility.RDS")
