...
for (y in 1:3){
  # Read in DHS data
  if (y == 1){
    all_data <- readRDS("data/DHS/zw_mothers_15.RDS")
  } else if (y == 2){
    all_data <- readRDS("data/DHS/zw_mothers_10.RDS")
  } else {
    all_data <- readRDS("data/DHS/zw_mothers_05.RDS")
  }
...
saveRDS(df_fertility, file = "data/Zimbabwe/female_fertility.RDS")
