dhs <- readRDS("TheLancet_global_minimum_estimates_2021/data/Brazil/female_fertility.RDS")
dhs2 <- readRDS("TheLancet_global_minimum_estimates_2021/data/Brazil/female_fertility_half.RDS")

ihme <- read_csv("TheLancet_global_minimum_estimates_2021/data/fertility/IHME_both_files.csv")
...
p <- ggplot() + 
  ...
  xlab("Age of woman")
print(p)
ggsave("TheLancet_global_minimum_estimates_2021/figures/br_female_2015.pdf", p, width = 6, height = 5)
