...
saveRDS(ratio_dat, "TheLancet_global_minimum_estimates_2021/data/orphanhood_ratios.RDS")
...
saveRDS(orphans_sample, "TheLancet_global_minimum_estimates_2021/data/country_estimates_pa.RDS")
...
save(p_fit_pa_label, p_obs_pred_pa, p_loo_pa, file = "TheLancet_global_minimum_estimates_2021/data/extrapolate_parent.RData")
