source(file.path("TheLancet_global_minimum_estimates_2021/R","process_children_parents.R"))
source(file.path("TheLancet_global_minimum_estimates_2021/R","process_fertility.R"))
source(file.path("TheLancet_global_minimum_estimates_2021/R","process_child_mortality.R"))
...
process_number_children_brazil <- function(){
  ...
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Brazil/male_fertility.RDS')
  ...
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Brazil/brazil_fertility_m_all.csv'))
  ...
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Brazil/female_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'  
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Brazil/brazil_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_colombia <- function(){
  # Calculate number of children from different aged fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Colombia/male_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  write_csv(data_f, file = paste0('TheLancet_global_minimum_estimates_2021/data/Colombia/colombia_fertility_m_all.csv'))
  ...
  # Calculate number of children from different aged mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Colombia/female_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Colombia/colombia_fertility_f.csv'))
...
process_number_children_england_wales <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_m.csv')
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv('TheLancet_global_minimum_estimates_2021/data/UK/england_wales_fertility_f.csv')
  data_f = copy(data)
  data_f$fertility_rate <- data_f$rate/1000
  data_f$date = data_f$year
  data_f$gender = 'F'
...
process_number_children_france <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/France/france_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/France/france_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
...
process_number_children_germany <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Germany/germany_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_india <- function(){
  cat(sprintf("Processing number of children of fathers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/India/male_fertility.RDS')
  data$y2016 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/India/india_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/India/female_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/India/india_fertility_f.csv'))
...
process_number_children_iran <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Iran/iran_fertility_m_all.csv'))
  data_f$fertility_rate = data_f$fertility_rate/1000
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Iran/iran_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_italy <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Italy/italy_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_kenya <- function(){
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Kenya/male_fertility.RDS')
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Kenya/kenya_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Kenya/female_fertility.RDS')
  data$y2015 = data$y2014
  data$y2016 = data$y2015
  data$y2017 = data$y2016
  data$y2018 = data$y2016
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Kenya/kenya_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_malawi <- function(){
  ...
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Malawi/male_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Malawi/malawi_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Malawi/female_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Malawi/malawi_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_mexico <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Mexico/mexico_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_nigeria <- function(){
  ...
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Nigeria/male_fertility.RDS')
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Nigeria/nigeria_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Nigeria/female_fertility.RDS')
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Nigeria/nigeria_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_peru <- function(){
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Peru/male_fertility.RDS')
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'  
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Peru/peru_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Peru/female_fertility.RDS')
  data$y2013 = data$y2012
  data$y2014 = data$y2012
  data$y2015 = data$y2012
  data$y2016 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Peru/peru_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_philippines <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Philippines/philippines_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_poland <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Poland/poland_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Poland/poland_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_russia <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  cat(sprintf("Processing number of children of mothers\n"))
  country = 'Russia'
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Russia/russia_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_spain <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/Spain/spain_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_south_africa <- function(){
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/SouthAfrica/male_fertility.RDS')
  data$y2017 = data$y2016
  data$y2018 = data$y2016
  data$y2019 = data$y2016
  data$y2020 = data$y2016
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/SouthAfrica/southafrica_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/SouthAfrica/female_fertility.RDS')
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/SouthAfrica/southafrica_fertility_f.csv'))
  is_child_mortality_needed = 0
...
process_number_children_usa <- function(){
  ...
  # fathers
  cat(sprintf("Processing number of children of fathers\n"))
  data_f = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_m_all.csv'))
  data_f$fertility_rate <- data_f$fertility_rate/1000
  data_f$date = data_f$year
  data_f$age = as.character(data_f$age)
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = read.csv(paste0('TheLancet_global_minimum_estimates_2021/data/USA/usa_fertility_f.csv'))
  data_f = copy(data)
  data_f$fertility_rate = data_f$fertility_rate/1000
  d_2019 = data_f[which(data_f$date == '2019'),]
  d_2020 = copy(d_2019)
...
process_number_children_zimbabwe<- function(){
  ...
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Zimbabwe/male_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'M'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Zimbabwe/zimbabwe_fertility_m_all.csv'))
  ...
  # mothers
  cat(sprintf("Processing number of children of mothers\n"))
  data = readRDS('TheLancet_global_minimum_estimates_2021/data/Zimbabwe/female_fertility.RDS')
  data$y2016 = data$y2015
  data$y2017 = data$y2015
  data$y2018 = data$y2015
  data$y2019 = data$y2015
  ...
  data_f$date = data_f$year
  data_f$gender = 'F'
  write_csv(data_f, path = paste0('TheLancet_global_minimum_estimates_2021/data/Zimbabwe/zimbabwe_fertility_f.csv'))
  is_child_mortality_needed = 0
