...
saveRDS(ratio_dat, "TheLancet_global_minimum_estimates_2021/data/primary_secondary_ratios.RDS")
...
save(p_fit_ps_label, p_obs_pred_ps, p_loo_ps, file = "TheLancet_global_minimum_estimates_2021/data/extrapolate_primary_secondary.RData")
