...
# Reads in orphans
orphans = data.frame(readRDS("TheLancet_global_minimum_estimates_2021/orphans.RDS"))
orphans$country = row.names(orphans)
orphans$country[which(orphans$country == "USA")] = "US"

# Reads in deaths
deaths = read.csv("TheLancet_global_minimum_estimates_2021/data/04-30-2021.csv", stringsAsFactors = FALSE)
...
# Read in WHO regions
regions <- read.csv(file = "TheLancet_global_minimum_estimates_2021/data/who_regions.csv", stringsAsFactor = FALSE)
deaths_country = left_join(deaths_country, regions)

# Read in covariates
fertility = read_excel("TheLancet_global_minimum_estimates_2021/data/WPP2019_FERT_F04_TOTAL_FERTILITY.xlsx", sheet = 2)
...
fertility_l = read_excel("TheLancet_global_minimum_estimates_2021/data/WPP2019_FERT_F04_TOTAL_FERTILITY.xlsx", sheet = 4)
...
fertility_u = read_excel("TheLancet_global_minimum_estimates_2021/data/WPP2019_FERT_F04_TOTAL_FERTILITY.xlsx", sheet = 3)
...
saveRDS(joined, "TheLancet_global_minimum_estimates_2021/data/tfr_covariates.RDS")