...
month = "_oct"
n = 1000
percentages = readRDS(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled", month, ".RDS"))
percentages_ = percentages
samples <- readRDS(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/samples_age_data_scaled", month, ".RDS"))
samples$sample <- rep(rep(1:n, each = 6), times = 20)


# Diagram: Updated numbers  ----------------------------------------------
ps <- readRDS("TheLancetCAH_global_age_analysis_2022/data/formatted_primary_secondary.RDS")
p <- readRDS("TheLancetCAH_global_age_analysis_2022/data/formatted_primary.RDS")
pa <- readRDS("TheLancetCAH_global_age_analysis_2022/data/formatted_parents.RDS")

dat <- data.frame(parents = pa,
                  primary = p,
                  primary_seconday = ps)
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/updated_numbers", month, ".csv"), dat, row.names=FALSE)
...
global_totals <- readRDS("TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_extrapolation_totals.RDS")
names(global_totals) <- names(tab_combined)
tab_combined_ <- rbind(tab_combined, global_totals)

write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/table_2_age_breakdown", month, ".csv"), tab_combined_, row.names=FALSE)
...
#global_dat = read.csv("TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_age_percentages.csv")
...
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_compostion", month, ".csv"), pretty_table_wide_raw, row.names=FALSE)
...
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/gender_compostion.csv"), percentages_gender_wide, row.names=FALSE)
...
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_compostion.csv"), percentages_age_wide, row.names=FALSE)
...
children_numbers <- read.csv("TheLancetCAH_global_age_analysis_2022/data/numbers_of_children_smaller.csv")
...
ggsave(paste0("TheLancetCAH_global_age_analysis_2022/figures/fig_2_age_composition", month, ".pdf"),  p, height = 14,  width = 14)
...
# Merging regions  ----------------------------------------------
regions <- read.csv("TheLancetCAH_global_age_analysis_2022/data/who_regions.csv")
...
pop = readRDS("TheLancetCAH_global_age_analysis_2022/data/grouped_age_sex_population.RDS")
...
ggsave(paste0("TheLancetCAH_global_age_analysis_2022/figures/orphanhood_rates_age", month, ".pdf"),  p, height = 14,  width = 10)


# Time varying figure ----------------------------------------------
percentages_diff = readRDS(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled_diff.RDS"))
...
percentages_initial = readRDS(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled.RDS"))
...
ggsave(paste0("TheLancetCAH_global_age_analysis_2022/figures/s1_timeseries_age_composition", month, ".pdf"),  p2, height = 7,  width = 14)
