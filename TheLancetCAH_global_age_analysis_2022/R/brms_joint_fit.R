...
joint_fit <- function(all_data, data, formula, plot = FALSE, loo = FALSE){
  ...
  mod_full <- brm(formula, data = data, seed = 2,
                  ...
                  file = "TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_age_fit.RDS")
  ...
  if (plot == TRUE){
    ...
    p <- cowplot::plot_grid(p_m_10_17, p_p_10_17,
                            ...
                            p_m_0_4, p_p_0_4,
                            ncol = 2, labels = "AUTO")
    ggsave("TheLancetCAH_global_age_analysis_2022/figures/observed_predicted.pdf", p, width = 8, height = 10)
  }
