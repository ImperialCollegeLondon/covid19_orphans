...
dat = read.csv("TheLancetCAH_global_age_analysis_2022/data/us_census_population.csv") 
...
eng = read_excel("TheLancetCAH_global_age_analysis_2022/data/england_wales_pop.xlsx")
eng = eng[8:98,5:8]
...
ggsave("TheLancetCAH_global_age_analysis_2022/figures/pop_pyramids.pdf", n1, height = 14, width = 8)
...
saveRDS(bespoke_bands, file = "TheLancetCAH_global_age_analysis_2022/data/bespoke_population_bands.RDS")
...
saveRDS(dat_study_group_long, "TheLancetCAH_global_age_analysis_2022/data/grouped_age_sex_population.RDS")
