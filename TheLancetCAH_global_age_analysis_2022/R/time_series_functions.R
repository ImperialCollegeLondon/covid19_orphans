...
calculate_all_orphans_time_series <- function(c_data, date){
  # Read study data in
  study_ratios <- readRDS("TheLancetCAH_global_age_analysis_2022/data/shiny/calculated_ratios.RDS")
  
  # Calculate
  ps_orphans <- calculate_orphans_time(c_data, readRDS("TheLancetCAH_global_age_analysis_2022/data/shiny/primary_secondary_coefficients.RDS"), 
