...
print(output_ps$par)
saveRDS(output_ps$par, "TheLancetCAH_global_age_analysis_2022/data/shiny/primary_secondary_coefficients.RDS")
...
saveRDS(ratio_dat, "TheLancetCAH_global_age_analysis_2022/data/primary_secondary_ratios.RDS")
...
saveRDS(sprintf("%s [%s - %s]", 
        ...
        file = "TheLancetCAH_global_age_analysis_2022/data/formatted_primary_secondary.RDS")
saveRDS(c(sum(joined$final_orphans), quantile(orphans_samples, probs = 0.025),  quantile(orphans_samples, probs = 0.975)), 
        file = "TheLancetCAH_global_age_analysis_2022/data/un_formatted_primary_secondary.RDS")
...
saveRDS(orphans_samples_swapped, "TheLancetCAH_global_age_analysis_2022/data/ps_total_samples.RDS")

orphanhood_country <- as.data.frame(estimates_orphans)
orphanhood_country$country <- ratio_dat$country
saveRDS(orphanhood_country, "TheLancetCAH_global_age_analysis_2022/data/ps_samples.RDS")
...
saveRDS(orphans_sample, "TheLancetCAH_global_age_analysis_2022/data/country_estimates_ps.RDS")
...
saveRDS(reg, "TheLancetCAH_global_age_analysis_2022/data/age_outputs/reg_ps.RDS")
saveRDS(reg_samples_, "TheLancetCAH_global_age_analysis_2022/data/age_outputs/reg_ps_samples.RDS")
...
save(p_fit_ps_label, p_obs_pred_ps, file = "TheLancetCAH_global_age_analysis_2022/data/extrapolate_primary_secondary.RData")
