...
print(output_p$par)
saveRDS(output_p$par, "TheLancetCAH_global_age_analysis_2022/data/shiny/parent_coefficients.RDS")
...
saveRDS(ratio_dat, "TheLancetCAH_global_age_analysis_2022/data/orphanhood_ratios.RDS")
...
saveRDS(sprintf("%s [%s - %s]", 
        ...
        file = "TheLancetCAH_global_age_analysis_2022/data/formatted_parents.RDS")

saveRDS(c(sum(joined$final_parent_orphans), quantile(orphans_samples, probs = 0.025),  quantile(orphans_samples, probs = 0.975)), 
        file = "TheLancetCAH_global_age_analysis_2022/data/un_formatted_parents.RDS")
...
saveRDS(orphans_samples_swapped, "TheLancetCAH_global_age_analysis_2022/data/pa_total_samples.RDS")

orphanhood_country <- as.data.frame(estimates_parent_orphans)
orphanhood_country$country <- ratio_dat$country
saveRDS(orphanhood_country, "TheLancetCAH_global_age_analysis_2022/data/orphanhood_samples.RDS")
...
saveRDS(orphans_sample, "TheLancetCAH_global_age_analysis_2022/data/country_estimates_pa.RDS")
...
saveRDS(reg, "TheLancetCAH_global_age_analysis_2022/data/age_outputs/reg_pa.RDS")
saveRDS(reg_samples_, "TheLancetCAH_global_age_analysis_2022/data/age_outputs/reg_pa_samples.RDS")
...
save(p_fit_pa_label, p_obs_pred_pa, file = "TheLancetCAH_global_age_analysis_2022/data/extrapolate_parent.RData")
