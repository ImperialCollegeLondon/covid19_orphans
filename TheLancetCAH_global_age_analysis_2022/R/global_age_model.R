...
library(xtable)
library(ggpubr)
source("TheLancetCAH_global_age_analysis_2022/R/brms_joint_fit.R")
source("TheLancetCAH_global_age_analysis_2022/R/utils.R")

set.seed(1)

month = "_oct"
data = readRDS(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled", month, ".RDS"))

# Read in TFR
covariarates = readRDS("TheLancetCAH_global_age_analysis_2022/data/tfr_covariates.RDS")
...
# Read in population
population = readRDS("TheLancetCAH_global_age_analysis_2022/data/bespoke_population_bands.RDS")
...
# Read in GDP
gdp <- read.csv("TheLancetCAH_global_age_analysis_2022/data/gdp.csv", header = FALSE, stringsAsFactors = FALSE) #(https://data.worldbank.org/indicator/NY.GDP.MKTP.CD)
...
orphan <- readRDS("TheLancetCAH_global_age_analysis_2022/data/country_estimates_pa.RDS")
...
mod = readRDS("TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_age_fit.RDS")

# Out of sample prediction
newdat = all_data
samples <- readRDS("TheLancetCAH_global_age_analysis_2022/data/orphanhood_samples.RDS")
...
write.csv(samples_array, file = "TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_prediction_before_switching.csv", row.names=FALSE)

# Exchange out of sample prediction for bootstrapped samples for study countries
study_samples = read.csv(paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/samples_age_data_scaled", month, ".csv"))
...
write.csv(samples_array, file = "TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_prediction.csv", row.names=FALSE)
...
mean_data = read.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled", month, ".csv"))
...
write.csv(data_save, file = "TheLancetCAH_global_age_analysis_2022/data/age_outputs/country_specific_totals.csv", row.names=FALSE)
...
saveRDS(rbind(global_totals, global_totals_2), 
        "TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_extrapolation_totals.RDS")
...
write.csv(tab_wide, "TheLancetCAH_global_age_analysis_2022/data/age_outputs/global_age_percentages.csv", row.names=FALSE)
...
print(p_global)
ggsave("TheLancetCAH_global_age_analysis_2022/figures/fig_3_global_orphans_percentage.pdf", p_global, height = 7)
...
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_compostion_region.csv"), reg_age_wide, row.names=FALSE)
...
write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/gender_compostion_region.csv"), reg_gender_wide, row.names=FALSE)
