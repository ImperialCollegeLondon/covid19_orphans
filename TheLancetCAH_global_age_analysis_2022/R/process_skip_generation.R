...
pop_data_m <- read_xlsx("TheLancetCAH_global_age_analysis_2022/data/WPP2019_POP_F07_2_POPULATION_BY_AGE_MALE.xlsx")
...
pop_data_f <- read_xlsx("TheLancetCAH_global_age_analysis_2022/data/WPP2019_POP_F07_3_POPULATION_BY_AGE_FEMALE.xlsx")
...
# Argentina
process_argentina_skip_generation = function(month = ""){
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Argentina/covid19_deaths', month, '.csv'))
  ...
  skip_gen = read_xlsx("TheLancetCAH_global_age_analysis_2022/data/skip_gen.xlsx")
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Argentina/skip_generation_argentina.csv', data, row.names=FALSE)
  print(data)
}

# Brazil
process_brazil_skip_generation = function(month = ""){
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Brazil/covid19_deaths', month, '.csv'))
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Brazil/skip_generation_brazil.csv', data, row.names=FALSE)
  print(data)
}

# Colombia
process_colombia_skip_generation = function(month = ""){
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Colombia/covid19_deaths_all', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Colombia/skip_generation_colombia.csv', data, row.names=FALSE)
  print(data)
}

# England and Wales
process_skip_generation_england_wales = function(month = "", max_excess_covid = 0 ){
  data = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales', month, '.csv'))
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/UK/skip_generation_england_wales.csv', data, row.names=FALSE)

  print(data)
}

# France
process_france_skip_generation = function(month = ""){
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/France/france_all', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/France/skip_generation_france.csv'), data, row.names=FALSE)
  print(data)
}

# Germany
process_germany_skip_generation = function(month = ""){
  country = 'germany'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Germany/covid19_deaths', month, '.csv'))
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Germany/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# India
process_india_skip_generation = function(month = ""){
  country = 'india'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/India/all_covid_deaths', month, '.csv'))
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/India/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Iran
process_iran_skip_generation = function(month = ""){
  country = 'iran'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Iran/iran_all', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Iran/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Italy
process_italy_skip_generation = function(month = ""){
  country = 'italy'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Italy/italy_all', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Italy/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Kenya
process_kenya_skip_generation = function(month = ""){
  country = 'kenya'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Kenya/covid19_deaths', month, '.csv'))
  ...
  data$number = round(data$number)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Kenya/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Malawi
process_malawi_skip_generation = function(month = ""){
  country = 'malawi'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Malawi/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Malawi/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Mexico
process_mexico_skip_generation = function(month = ""){
  country = 'mexico'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Mexico/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Mexico/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Nigeria
process_nigeria_skip_generation = function(month = ""){
  country = 'nigeria'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  d_summary$age = ifelse(d_summary$age %in% c("60-64", "65-69", "70-74", "75-79", "80-84"),'60+', 'others')
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Nigeria/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Peru
process_peru_skip_generation = function(month = ""){
  country = 'peru'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Peru/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Philippines
process_philippines_skip_generation = function(month = ""){
  country = 'philippines'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Philippines/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Philippines/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Poland
process_poland_skip_generation = function(month = ""){
  country = 'poland'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Poland/poland_all', month, '.csv'))
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Poland/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Russia
process_russia_skip_generation = function(month = ""){
  country = 'russia'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Russia/all_excess_deaths', month, '.csv'))
  d_summary$age = ifelse(d_summary$age %in% c("60-64", "65-69","70-74", "75-79", "80-84"),'60+', 'others')
  #% female % male 
  data = d_summary %>% filter(age == '60+') %>% group_by(sex) %>% 
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Russia/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Spain
process_spain_skip_generation = function(month = ""){
  country = 'spain'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Spain/spain_all', month, '.csv'))
  #setnames(d_summary, c('death'), c('deaths'))
  d_summary = d_summary %>% group_by(age, gender) %>% mutate(nb_deaths = sum(deaths)) %>% ungroup() %>% 
    select(age, gender, nb_deaths) %>% distinct()
  setnames(d_summary, 'nb_deaths', 'deaths')
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Spain/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# South Africa
process_south_africa_skip_generation = function(month = ""){
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths', month, '.csv'))
  setnames(d_summary, c('COVID19_deaths'), c('deaths'))
  d_summary = d_summary %>% group_by(age, gender) %>% mutate(nb_deaths = sum(deaths)) %>% ungroup() %>% 
    select(age, gender, nb_deaths) %>% distinct()
  setnames(d_summary, 'nb_deaths', 'deaths')
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/skip_generation_south_africa.csv', data, row.names=FALSE)
  print(data)
}

# USA
process_usa_skip_generation = function(month = ""){
  country = 'usa'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/USA/usa_all', month, '.csv'))
  d_summary = d_summary %>% group_by(age, gender) %>% mutate(nb_deaths = sum(deaths)) %>% ungroup() %>% 
    select(age, gender, nb_deaths) %>% distinct()
  setnames(d_summary, 'nb_deaths', 'deaths')
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/USA/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}

# Zimbabwe
process_zimbabwe_skip_generation = function(month = ""){
  country = 'zimbabwe'
  d_summary = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/covid19_deaths', month, '.csv'))
  d_summary$age = as.character(d_summary$age)
  ...
  data$grand_deaths = round(data$grand_deaths)
  data$value = round(data$value)
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/skip_generation_', country,'.csv'), data, row.names=FALSE)
  print(data)
}
