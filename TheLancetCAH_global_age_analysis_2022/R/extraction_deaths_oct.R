...
process_euro_excess_new = function(){
  list_excel = readxl::excel_sheets('TheLancetCAH_global_age_analysis_2022/data/DEMO_R_MWK_05_custom.xlsx')
  list_excel = list_excel[3:length(list_excel)]
  x <- lapply(list_excel, function(X) readxl::read_excel('TheLancetCAH_global_age_analysis_2022/data/DEMO_R_MWK_05_custom.xlsx', sheet = X))
  names(x) <- list_excel
  ...
  for (i in seq(length(list_excel))){
    ...
    df[,week:= week]
    df[,year:= day]
    setnames(df, c(2:9), c('Spain', '1', 'France', '2', 'Italy', '3', 'Poland', '4'))
    df = df %>% select(year, week, Spain, France, Italy, Poland)
  ...
  write.csv(age_summary, file = paste0("TheLancetCAH_global_age_analysis_2022/data/euro_excess_oct.csv"), row.names = FALSE)
}

# Process Argentina - covid only, updated to 27 oct
process_argentina_covid19 = function(){
  data = read.csv('TheLancetCAH_global_age_analysis_2022/data/Argentina/Argentina - Deaths by age and sex (rates per 100,000)-oct.csv')
  ...
  deaths_data = read.csv("TheLancetCAH_global_age_analysis_2022/data/10-31-2021.csv")
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Argentina/covid19_deaths_oct.csv', d_merge, row.names=FALSE)
  #d_merge
}
...
process_brazil = function(age_range){
  ...
  download.file(url, file.file('TheLancetCAH_global_age_analysis_2022/data/Brazil/', file_name))
  df_SIVEP_ORIGINAL=read_csv2(file.file('TheLancetCAH_global_age_analysis_2022/data/Brazil/', file_name))
  ...
  if(!file.exists(file.file('TheLancetCAH_global_age_analysis_2022/data','Brazil')))
  {
    dir.create(file.file('TheLancetCAH_global_age_analysis_2022/data','Brazil'))
  }
  ...
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/Brazil/","brazil_summary_oct.csv"),tmp, row.names=FALSE)
  
  d_merge = tmp
  d_merge$date = as.Date(d_merge$date)
  d_merge = d_merge[which(d_merge$date <= as.Date("2021-10-31")),]
  d_merge = d_merge %>% 
  ...
  d_merge$date = rep('2021-10-31', length(d_merge$date))
  d_merge$rate = d_merge$deaths/sum(d_merge$deaths)
  d_merge$deaths = round(d_merge$rate * total)
  setnames(d_merge, 'deaths', 'COVID19_deaths')
  write.csv(d_merge %>% select(-rate), file = 'TheLancetCAH_global_age_analysis_2022/data/Brazil/covid19_deaths_oct.csv', row.names=FALSE)
}

#Colombia
process_colombia_covid19 = function(){
  data = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/Colombia/COVID19_Colombia_by_sex_and_age_oct.xlsx')
  data = as.data.table(data)
  data$Total <- NULL
  data = gather(data, key = "gender", value = "covid19_deaths", -age)
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Colombia/covid19_deaths_all_oct.csv', row.names=FALSE)
}
...
process_england_wales = function(uncertainty = FALSE){
  ...
  #download.file(url_previous, 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_pre_deaths_oct.xlsx')
  data = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_pre_deaths_oct.xlsx', sheet = 2)
  ...
  data2 = read.csv("TheLancetCAH_global_age_analysis_2022/data/UK/weekly-deaths-age-sex-covid-19-v55.csv")
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales_oct.csv', d_deaths, row.names=FALSE)
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales_oct.csv', d_merge, row.names=FALSE)
  
}

# France
process_france = function(){
  tmp = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/France/France_2021_10_28_Deaths_Covid_19.xlsx', sheet = 2)
  ...
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/France/","france_all_oct.csv"),d_merge, row.names=FALSE)
  ...
  write.csv(d_merge, file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_all_oct.csv', row.names=FALSE)
}

# Germany
process_germany = function(){
  tmp = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/Germany/Germany_2021_10_28_Deaths_Covid-19.xlsx', sheet = 2)
  data = tmp[7:16, c(1,c(8,10,13))]
  data = data.frame(data)
  names(data) = c('age', 'male', 'female', 'both')
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/covid19_deaths_oct.csv', row.names=FALSE)
}
...
process_india_covid = function(){
  ...
  write.csv(d_summary %>% arrange(age, sex), file = 'TheLancetCAH_global_age_analysis_2022/data/India/all_covid_deaths_oct.csv', row.names=FALSE)
  ...
  write.csv(d_summary, file = 'TheLancetCAH_global_age_analysis_2022/data/India/covid_deaths_oct.csv', row.names=FALSE)
}
...
process_iran <- function(){
  ...
  write.csv(covid_data, file = 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_all_oct.csv', row.names=FALSE)
}

# Italy
process_italy = function(){
  tmp = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/Italy/Italy_2021_10_28_Deaths_Covid-19.xlsx', sheet = 2)
  data = tmp[7:16, c(1,c(8,10,13))]
  data = data.frame(data)
  names(data) = c('age', 'male', 'female', 'both')
  data$male = as.numeric(data$male)
  ...
  d_merge = left_join(data, excess_death, by = c('gender', 'age' = 'age'))
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/Italy/","italy_all_oct.csv"),d_merge, row.names=FALSE)
  ...
  d_merge$deaths = ifelse(d_merge$covid_deaths > d_merge$excess_deaths, d_merge$covid_deaths, d_merge$excess_deaths)
  d_merge = d_merge %>% select(age, gender, covid_deaths, excess_deaths, deaths)
  write.csv(d_merge, file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_all_oct.csv', row.names=FALSE)
}
...
process_kenya_covid19 = function(){
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Kenya/covid19_deaths_oct.csv', row.names=FALSE)
}

# Malawi
process_malawi = function(){
  data = read_xls('TheLancetCAH_global_age_analysis_2022/data/Malawi/malawi_oct.xls')
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Malawi/covid19_deaths_oct.csv', row.names=FALSE)
}

# Mexico
process_mexico_covid19 = function(){
  data = read.csv('TheLancetCAH_global_age_analysis_2022/data/Mexico/Mexico - Deaths by age and sex (rates per 100,000)-oct.csv', fileEncoding="latin1")
  ...
  write.csv(data_combine %>% select(age, gender, deaths), file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/covid19_deaths_oct.csv', row.names=FALSE)
}

# Nigeria
process_nigeria_covid19 = function(){
  d_merge = read.csv('TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths_raw_oct.csv')
  ...
  d_merge$rate = d_merge$deaths/sum(d_merge$deaths)
  d_merge$deaths = round(d_merge$rate * total)
  write.csv(d_merge %>% select(-rate), file = 'TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths_oct.csv', row.names=FALSE)
}

# Peru
process_peru_covid19 = function(){
  d_merge = read.csv('TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths_raw_oct.csv')
  ...
  write.csv(d_merge %>% select(-rate), file = 'TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths_oct.csv', row.names=FALSE)
}

# Philippines 

process_philippines = function(){
  #data_1 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211010 - 04 Case Information 2020.csv")
  #data_2 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211010 - 04 Case Information 2021_H1.csv")
  #data_3 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211010 - 04 Case Information 2021_Q3.csv")
  #data_4 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211010 - 04 Case Information 2021_Q4.csv")
  #data <- rbind(data_1, data_2, data_3, data_4)
  data_1 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211104 - 04 Case Information_batch_0.csv")
  data_2 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211104 - 04 Case Information_batch_1.csv")
  data_3 <- read_csv("TheLancetCAH_global_age_analysis_2022/data/Philippines/data_drop/DOH COVID Data Drop_ 20211104 - 04 Case Information_batch_2.csv")
  data <- rbind(data_1, data_2, data_3)
  
  data$DateDied <- as.Date(data$DateDied)
  
  data_sub <- data[which(data$RemovalType == 'DIED'),]
  data_sub <- data_sub[which(data_sub$DateDied <= as.Date('2021-10-31')),]
  ...
  if (total > sum(d$deaths)){
    ...
    write.csv(d, file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/covid19_deaths_oct.csv', row.names=FALSE)
  } else {
...
process_poland_covid19 = function(){
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/covid19_deaths_oct.csv', row.names=FALSE)
  
  data$COVID19_deaths = as.numeric(data$COVID19_deaths)
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/Poland/","poland_deaths_oct.csv"),data, row.names=FALSE)  
  total_covid = sum(data$COVID19_deaths)
  
  excess_death = read.csv('TheLancetCAH_global_age_analysis_2022/data/euro_excess_oct.csv')
  excess_death = as.data.table(excess_death) %>% select(week, year, poland, age, gender)
  excess_death = excess_death[!is.na(excess_death$poland),]
  excess_death$age = as.character(excess_death$age)
  ...
  d_merge = left_join(data, excess_death, by = c('gender', 'age' = 'age'))
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/Poland/","poland_all_oct.csv"),d_merge, row.names=FALSE)
  ...
  write.csv(d_merge, file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_all_oct.csv', row.names=FALSE)
...
process_russia_excess = function(){
  ...
  write.csv(d_summary %>% arrange(age, sex), file = 'TheLancetCAH_global_age_analysis_2022/data/Russia/all_excess_deaths_oct.csv', row.names=FALSE)
  ...
  write.csv(d_summary, file = 'TheLancetCAH_global_age_analysis_2022/data/Russia/excess_deaths_oct.csv', row.names=FALSE)
}


# Spain
process_spain = function(){
  tmp = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/Spain/Spain_2021_10_28_Deaths_Covid-19.xlsx', sheet = 6)
  ...
  d_merge = left_join(data, excess_death, by = c('gender', 'age' = 'age'))
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/Spain/","spain_all_oct.csv"),d_merge, row.names=FALSE)
  ...
  d_merge$deaths = ifelse(d_merge$covid_deaths > d_merge$excess_deaths, d_merge$covid_deaths, d_merge$excess_deaths)
  d_merge = d_merge %>% select(age, gender, covid_deaths, excess_deaths, deaths)
  write.csv(d_merge, file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_all_oct.csv', row.names=FALSE)
}

# South Africa
process_sa_covid19 = function(){
  d_merge = read.csv('TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths_raw_oct.csv')
  ...
  write.csv(d_merge %>% select(-rate), file = 'TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths_oct.csv', row.names=FALSE)
}

# USA
process_usa = function(){
  tmp = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/USA/USA_2021_10_28_Deaths_Covid-19.xlsx', sheet = 2)
  ...
  #download.file(url, 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_excess_mortality_all_oct.csv')
  data = read.csv('TheLancetCAH_global_age_analysis_2022/data/USA/usa_excess_mortality_all_oct.csv')
  ...
  write.csv(file = ("TheLancetCAH_global_age_analysis_2022/data/USA/excess_deaths_oct.csv"),dataset, row.names=FALSE)
  ...
  write.csv(file = paste0("TheLancetCAH_global_age_analysis_2022/data/USA/","usa_all_oct.csv"),d_merge, row.names=FALSE)
  ...
  write.csv(d_merge, file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_all_oct.csv', row.names=FALSE)
}
...
process_zimbabwe = function(){
  ...
  data = data %>% select(-rate)
  names(data) <- c("age", "gender", "deaths")
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/covid19_deaths_oct.csv', row.names=FALSE)
}
