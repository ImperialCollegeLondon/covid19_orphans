...
source("TheLancetCAH_global_age_analysis_2022/R/extraction_deaths_oct.R")
...
source("TheLancetCAH_global_age_analysis_2022/R/calculate_orphans.R")
source("TheLancetCAH_global_age_analysis_2022/R/process_skip_generation.R")
...
### Summary ###################################################################################
source("TheLancetCAH_global_age_analysis_2022/R/orphans_table_oct.R")
