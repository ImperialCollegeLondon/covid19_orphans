...
process_children_all = function(country, is_child_mortality_needed, data_f, uncertainty = FALSE){
  ...
  if (uncertainty == FALSE){
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_raw_f.csv'), children, row.names=FALSE)
  }
  ...
  if (is_child_mortality_needed){
    ...
    if (uncertainty == FALSE){
      write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_f.csv'), child_and_m, row.names=FALSE)
    }
  ...
  if (uncertainty == FALSE){
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_list_f.csv'), plot_c_and_m, row.names=FALSE) 
    setnames(plot_c_and_m, 'mother_age', 'parents_age')
    plott = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_list_m.csv')) 
    setnames(plott, 'father_age', 'parents_age')
    plot_all = rbind(plot_c_and_m, plott)
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_list_both_sex.csv'), plot_all, row.names=FALSE) 
  } else {
    setnames(plot_c_and_m, 'mother_age', 'parents_age')
    plott = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_list_m_un.csv')) 
    setnames(plott, 'father_age', 'parents_age')
    plot_all = rbind(plot_c_and_m, plott)
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_all_list_both_sex_un.csv'), plot_all, row.names=FALSE) 
  }
  ...
  if (uncertainty == FALSE){
    ...
    ddf$gender = 'female'
    ddf$age = 1:100
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/children_f.csv'), ddf, row.names=FALSE)
    
    ddf = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/children_f.csv'))
    ddf_2 = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country,'/children_m.csv'))
    ddf = rbind(ddf, ddf_2)
    p = ggplot(ddf) +
    ...
    ggsave(filename = paste0("TheLancetCAH_global_age_analysis_2022/figures/children_", tolower(country), ".pdf"), p, width = 6, height = 5)
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country,'/children.csv'), ddf, row.names=FALSE)
  }
 
}

process_children_father_england_wales = function(data_f, uncertainty = FALSE){
  ##
  children = matrix(rep(0, 100*18), nrow = 100)
  names(children) = paste0(seq(0:17), 'years')
  ...
  if (uncertainty == FALSE){
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/UK/child_raw_m.csv'), children, row.names=FALSE)
    plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
    plot_c$father_age = rep(1:100,18)
    plot_c$child_age =sort(rep(seq(18)-1, 100))
    setnames(plot_c, 1, 'prob')
  } else {
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/UK/child_raw_m_un.csv'), children, row.names=FALSE)
  }

}

# dhs
process_children_father_80_plus = function(country, data_f, uncertainty = FALSE){
  ##
  children = matrix(rep(0, 100*18), nrow = 100)
  names(children) = paste0(seq(0:17), 'years')
  ...
  if (uncertainty == FALSE){
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_raw_m.csv'), children, row.names=FALSE)
    plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
    plot_c$father_age = rep(1:100,18)
    plot_c$child_age =sort(rep(seq(18)-1, 100))
    setnames(plot_c, 1, 'prob')
  } else {
    write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/child_raw_m_un.csv'), children, row.names=FALSE)
  }
...
# Usa
process_children_father_55_plus = function(country, data_f, uncertainty = FALSE){
  ##
  children = matrix(rep(0, 100*18), nrow = 100)
  names(children) = paste0(seq(0:17), 'years')
...
process_children_father_60_plus = function(country, data_f){
  ...
  write.csv(file = paste0('TheLancetCAH_global_age_analysis_2022/data/Russia/child_raw_m.csv'), children, row.names=FALSE)
  plot_c = as.data.frame(as.numeric(as.character(unlist(children))))
  plot_c$father_age = rep(1:100,18)
  plot_c$child_age =sort(rep(seq(18)-1, 100))
  setnames(plot_c, 1, 'prob')
...
# Poland
process_children_father_50_plus = function(country, data_f, uncertainty){
  ##
  children = matrix(rep(0, 100*18), nrow = 100)
  names(children) = paste0(seq(0:17), 'years')
...
process_children_father_65_plus = function(country, data_f, uncertainty = FALSE){
  ##
  children = matrix(rep(0, 100*18), nrow = 100)
  names(children) = paste0(seq(0:17), 'years')
