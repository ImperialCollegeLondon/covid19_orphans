...
source("TheLancetCAH_global_age_analysis_2022/R/sample_deaths.R")
source("TheLancetCAH_global_age_analysis_2022/R/number_orphans_age.R")
source("TheLancetCAH_global_age_analysis_2022/R/process_number_children.R")
source("TheLancetCAH_global_age_analysis_2022/R/get_diff_deaths.R")

n = 1000

run_age_analysis <- function(month = "_oct"){
  if (month != "_diff"){
    source(paste0("TheLancetCAH_global_age_analysis_2022/R/extraction_deaths", month, ".R"))
  }
  ...
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Argentina/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Argentina/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Argentina/covid19_deaths_diff.csv')
  } else {
  ...
  saveRDS(arg, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Argentina", month, ".RDS"))
  ...
  if (month == "_diff"){
    get_diff_COVID19_deaths('TheLancetCAH_global_age_analysis_2022/data/Brazil/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Brazil/covid19_deaths_oct.csv', 
                            'TheLancetCAH_global_age_analysis_2022/data/Brazil/covid19_deaths_diff.csv', "Brazil")
  } else {
  ...
  bra$country = "Brazil"
  saveRDS(bra, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Brazil", month, ".RDS"))
  
  # Colombia -----------------------------------------------------------------
  cat(sprintf("Running Colombia======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths_colombia('TheLancetCAH_global_age_analysis_2022/data/Colombia/covid19_deaths_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/Colombia/covid19_deaths_all_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Colombia/covid19_deaths_all_diff.csv', "Colombia")
  } else {
  ...
  saveRDS(col, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Colombia", month, ".RDS"))
  
  # England and Wales -----------------------------------------------------------------
  cat(sprintf("Running England and Wales======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales.csv', 'TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/UK/deaths_all_england_wales_diff.csv')
  } else {
  ...
  saveRDS(eng, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/England", month, ".RDS"))
  
  # France -----------------------------------------------------------------
  cat(sprintf("Running France ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/France/france_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/France/france_all_oct.csv',
                    'TheLancetCAH_global_age_analysis_2022/data/France/france_all_diff.csv')
  } else {
    process_france()
  }
  ...
  saveRDS(fra, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/France", month, ".RDS"))
  
  # Germany -----------------------------------------------------------------
  cat(sprintf("Running Germany ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Germany/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Germany/covid19_deaths_oct.csv',
                    'TheLancetCAH_global_age_analysis_2022/data/Germany/covid19_deaths_diff.csv')
  } else {
    process_germany()
  }
  ...
  ger$country = "Germany"
  saveRDS(ger, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Germany", month, ".RDS"))
  
  # India -----------------------------------------------------------------
  cat(sprintf("Running India ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths_india('TheLancetCAH_global_age_analysis_2022/data/India/all_covid_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/India/all_covid_deaths_oct.csv',
                          'TheLancetCAH_global_age_analysis_2022/data/India/all_covid_deaths_diff.csv', "India")
  } else {
    process_india_covid()
  }
  ...
  saveRDS(ind, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/India", month, ".RDS"))
  
  # Iran -----------------------------------------------------------------
  cat(sprintf("Running Iran ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Iran/iran_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_all_oct.csv',
                    'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_all_diff.csv', "Iran (Islamic Republic of)")
  } else {
    process_iran()
  }
  ...
  saveRDS(ira, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Iran", month, ".RDS"))
  
  # Italy -----------------------------------------------------------------
  cat(sprintf("Running Italy ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Italy/italy_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_all_oct.csv',
                    'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_all_diff.csv')
  } else {
    process_italy()
  }
  ...
  ita$country = "Italy"
  saveRDS(ita, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Italy", month, ".RDS"))
  
  # Kenya -----------------------------------------------------------------
  cat(sprintf("Running Kenya ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Kenya/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Kenya/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Kenya/covid19_deaths_diff.csv')
  } else {
  ...
  ken$country = "Kenya"
  saveRDS(ken, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Kenya", month, ".RDS"))
  
  # Malawi -----------------------------------------------------------------
  cat(sprintf("Running Malawi ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Malawi/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Malawi/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Malawi/covid19_deaths_diff.csv')
  } else {
    process_malawi()
  }
  ...
  mal$country = "Malawi"
  saveRDS(mal, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Malawi", month, ".RDS"))
  
  # Mexico -----------------------------------------------------------------
  cat(sprintf("Running Mexico ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Mexico/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Mexico/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Mexico/covid19_deaths_diff.csv', "Mexico")
  } else {
  ...
  mex$country = "Mexico"
  saveRDS(mex, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Mexico", month, ".RDS"))
  
  # Nigeria -----------------------------------------------------------------
  cat(sprintf("Running Nigeria ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Nigeria/covid19_deaths_diff.csv')
  } else {
  ...
  nig$country = "Nigeria"
  saveRDS(nig, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Nigeria", month, ".RDS"))
  
  # Peru -----------------------------------------------------------------
  cat(sprintf("Running Peru ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_COVID19_deaths('TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/Peru/covid19_deaths_diff.csv')
  } else {
  ...
  per$country = "Peru"
  saveRDS(per, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Peru", month, ".RDS"))
  
  # Philippines -----------------------------------------------------------------
  cat(sprintf("Running Philippines ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_COVID19_deaths('TheLancetCAH_global_age_analysis_2022/data/Philippines/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Philippines/covid19_deaths_oct.csv', 
                            'TheLancetCAH_global_age_analysis_2022/data/Philippines/covid19_deaths_diff.csv')
  } else {
  ...
  saveRDS(phi, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Philippines", month, ".RDS"))
  
  # Poland -----------------------------------------------------------------
  cat(sprintf("Running Poland ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_death('TheLancetCAH_global_age_analysis_2022/data/Poland/poland_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_all_oct.csv', 
                            'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_all_diff.csv')
  } else {
  ...
  saveRDS(pol, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Poland", month, ".RDS"))
  ...
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Spain/spain_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_all_oct.csv', 
                   'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_all_diff.csv')
  } else {
    process_spain()
  }
  ...
  spa$country = "Spain"
  saveRDS(spa, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Spain", month, ".RDS"))
  
  # South Africa -----------------------------------------------------------------
  cat(sprintf("Running South Africa ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_COVID19_deaths('TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths_oct.csv', 
                            'TheLancetCAH_global_age_analysis_2022/data/SouthAfrica/covid19_deaths_diff.csv', "South Africa")
  } else {
    process_sa_covid19()
  }
  ...
  saveRDS(sa, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/SouthAfrica", month, ".RDS"))
  
  # USA -----------------------------------------------------------------
  cat(sprintf("Running USA ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/USA/usa_all.csv', 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_all_oct.csv', 
                    'TheLancetCAH_global_age_analysis_2022/data/USA/usa_all_diff.csv')
  } else {
    process_usa()
  }
  ...
  usa$country = "USA"
  saveRDS(usa, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/USA", month, ".RDS"))
  
  # Zimbabwe -----------------------------------------------------------------
  cat(sprintf("Running Zimbabwe ======\n"))
  cat(sprintf("Calculating central estimate\n"))
  if (month == "_diff"){
    get_diff_deaths('TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/covid19_deaths.csv', 'TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/covid19_deaths_oct.csv', 
                            'TheLancetCAH_global_age_analysis_2022/data/Zimbabwe/covid19_deaths_diff.csv')
  } else {
    process_zimbabwe()
  }
  ...
  saveRDS(zim, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/Zimbabwe", month, ".RDS"))
  ...
  saveRDS(percentages, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data", month, ".RDS"))
  saveRDS(samples, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/samples_age_data", month, ".RDS"))
  ...
  saveRDS(percentages, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled", month, ".RDS"))
  saveRDS(samples, paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/samples_age_data_scaled", month, ".RDS"))
  
  write.csv(percentages, file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/age_data_scaled", month, ".csv"), row.names=FALSE)
  write.csv(samples, file = paste0("TheLancetCAH_global_age_analysis_2022/data/age_outputs/samples_age_data_scaled", month, ".csv"), row.names=FALSE)
}
