...
process_fertility_plots = function(country){
  if (country == 'england_wales'){
    data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_all.csv')
    ...
    data_father = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/', tolower(country), '_fertility_m_all.csv'))
    data_mother = read.csv(paste0('TheLancetCAH_global_age_analysis_2022/data/', country, '/', tolower(country), '_fertility_f.csv'))
  ...
  ggsave(paste0("TheLancetCAH_global_age_analysis_2022/figures/fertility_", tolower(country), ".pdf"), width = 10, height = 4)
}

# Process fertility data
process_fertility_all_countries = function(){
  all_combine = NaN
  list_file = list.files('TheLancetCAH_global_age_analysis_2022/data/fertility_update', '.json')
  ...
  for (name_file in list_file)
  {
    ...
    json_data = suppressWarnings(fromJSON(paste(readLines(paste0('TheLancetCAH_global_age_analysis_2022/data/fertility_update/',name_file)))))
    data = as.data.table(unlist(json_data))
    data$country = names(json_data)
    setnames(data, 1, 'idx')
    dataset = readxl::read_xls(paste0('TheLancetCAH_global_age_analysis_2022/data/fertility_update/', strsplit(name_file, '.json')[[1]][1],'.xls'), sheet = 1)
  ...
  write.csv(file = "TheLancetCAH_global_age_analysis_2022/data/fertility_update/parents_live_births.csv", all_combine, row.names=FALSE)
}
...
process_england_wales_fertility = function(uncertainty = FALSE, seed){
  ...
  #download.file(url, 'TheLancetCAH_global_age_analysis_2022/data/fertility/england_wales_births.xls')
  data = readxl::read_xls('TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_births.xls', sheet = 11)
  ...
  # pop = read.csv('TheLancetCAH_global_age_analysis_2022/data/UK/pop_england_wales.csv')
  # pop = pop[,c(3:24)]
  ...
  # pop$gender = 'M'
  # saveRDS(pop1, "TheLancetCAH_global_age_analysis_2022/data/UK/pop1_male.RDS")
  # saveRDS(pop, "TheLancetCAH_global_age_analysis_2022/data/UK/pop_male.RDS")
  # 
  pop1 <- readRDS("TheLancetCAH_global_age_analysis_2022/data/UK/pop1_male.RDS")
  ...
  pop <- readRDS("TheLancetCAH_global_age_analysis_2022/data/UK/pop_male.RDS")
  ...
  ##  per 1000 men
  if (uncertainty == FALSE){
    write.csv(data_all, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_m.csv', row.names=FALSE)
  } else {
    write.csv(data_all, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_m_un.csv', row.names=FALSE)
  }
  
  # female
  # url = 'https://www.ons.gov.uk/file?uri=%2fpeoplepopulationandcommunity%2fbirthsdeathsandmarriages%2flivebirths%2fdatasets%2fbirthsbyparentscharacteristics%2f2018/parentscharacteristics2018workbook.xls'
  #download.file(url, 'TheLancetCAH_global_age_analysis_2022/data/fertility/england_wales_births.xls')
  data = readxl::read_xls('TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_births.xls', sheet = 5)
  d_name = as.character(data[6,])
  d_name[1:2] = c('year', 'ignore')
  data = data[7:nrow(data),]
  names(data) = d_name
  ...
  write.csv(data, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_births_f.csv', row.names=FALSE)
  ...
  # setnames(pop, 'sex', 'gender')
  # saveRDS(pop, "TheLancetCAH_global_age_analysis_2022/data/UK/pop_female.RDS")
  
  pop = readRDS("TheLancetCAH_global_age_analysis_2022/data/UK/pop_female.RDS")
  d_data = merge(data, pop, by = c('age', 'gender', 'year'))
  d_data = as.data.table(d_data)
  if (uncertainty == FALSE){
    d_data[,rate := 1000* value /pop_nb]
    
    write.csv(d_data, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_f.csv', row.names=FALSE)
    
    d_all = rbind(d_data %>% select(-pop_nb, -value), data_all)
    write.csv(d_all, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_all.csv', row.names=FALSE)
    ...
    write.csv(d_data, file = 'TheLancetCAH_global_age_analysis_2022/data/UK/england_wales_fertility_f_un.csv', row.names=FALSE)
  }
...
process_france_fertility = function(uncertainty  = FALSE, seed){
  data_fertility = read.csv('TheLancetCAH_global_age_analysis_2022/data/fertility/unsd_live_births.csv')
  data_fertility = data_fertility %>% filter(country == 'France',
                                             age != 'Unknown - Inconnu',
                                             gender == 'Male')
  
  data_pop = readxl::read_xlsx('TheLancetCAH_global_age_analysis_2022/data/pop.xlsx', sheet = 2)
  countries = c('France')
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  #data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/France/fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  #ggplot(data_combine) +
  #  geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #  theme_bw()+
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    ...
    #download.file(url, 'TheLancetCAH_global_age_analysis_2022/data/afr.zip')
    #data = fread(unzip('TheLancetCAH_global_age_analysis_2022/data/afr.zip', files = 'IHME_GBD_2019_FERTILITY_1950_2019_ASFR_Y2020M10D27.CSV'))
    data = read.csv("TheLancetCAH_global_age_analysis_2022/data/IHME_GBD_2019_FERTILITY_1950_2019_ASFR_Y2020M10D27.CSV")
    ...
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_fertility_f_ihme.csv', d_rate_ihme, row.names=FALSE)
    
  }
  
  # from WPP
  data = read_excel("TheLancetCAH_global_age_analysis_2022/data/WPP2019_FERT_F07_AGE_SPECIFIC_FERTILITY.xlsx")
  ...
  if (uncertainty == TRUE){
    ...
    d_wpp_long_rep <- births %>% select(-pop, -num_births, -sample_births)
  }
  #ggplot() +
  ...
  #  facet_wrap(~date)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/France/france_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
...
process_germany_fertility = function(uncertainty = FALSE, seed){
  ...
  # live births per 1000 male
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_m_un.csv', data_combine, row.names=FALSE)
  }

  #data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  #ggplot(data_combine) +
  #  geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #  theme_bw()+
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Germany/germany_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
...
process_iran_fertility = function(uncertainty = FALSE, seed){
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_fertility_m_all.csv', m_iran, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Iran/iran_fertility_m_all_un.csv', m_iran, row.names=FALSE)
  }
...
process_italy_fertility = function(uncertainty = FALSE, seed){
  ...
  # live births per 1000 male
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  
  #data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_m.csv')
  #data_combine$year = as.character(data_combine$year)
  #ggplot(data_combine) +
  #  geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #  theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if(uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Italy/italy_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
}
...
process_mexico_fertility = function(uncertainty = FALSE, seed){
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  # data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_m.csv')
  # data_combine$year = as.character(data_combine$year)
  # ggplot(data_combine) +
  #   geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #   theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Mexico/mexico_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
  
}

process_philippines_fertility = function(uncertainty = FALSE, seed){
  data_fertility = read.csv('TheLancetCAH_global_age_analysis_2022/data/fertility/unsd_live_births.csv', stringsAsFactors = FALSE)
  ...
  # live births per 1000 male
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  # 
  # data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_m.csv')
  # data_combine$year = as.character(data_combine$year)
  # ggplot(data_combine) +
  #   geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #   theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Philippines/philippines_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
...
process_poland_fertility = function(uncertainty = FALSE, seed){
  ...
  # live births per 1000 male
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  ...
  data_combine = data_combine %>% arrange(year, age)
  if(uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Poland/poland_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
...
process_russia_fertility = function(){
  ...
  data_combine[,fertility_rate := value / (pop)]
  # live births per 1000 male
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Russia/russia_fertility_m.csv', data_combine, row.names=FALSE)
  
  data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Russia/russia_fertility_m.csv')
  data_combine$year = as.character(data_combine$year)
  ggplot(data_combine) +
    geom_point(aes(x = age, y = fertility_rate, color = year)) +
    theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Russia/russia_fertility_m_all.csv', data_combine, row.names=FALSE)
  ...
  write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Russia/russia_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
}
...
process_spain_fertility = function(uncertainty = FALSE, seed){
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  
  # data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_m.csv')
  # data_combine$year = as.character(data_combine$year)
  # ggplot(data_combine) +
  #   geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #   theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/Spain/spain_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
...
process_usa_fertility = function(uncertainty = FALSE, seed){
  ...
  # live births per 1000 male
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_m.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_m_un.csv', data_combine, row.names=FALSE)
  }
  
  
  # data_combine = read.csv('TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_m.csv')
  # data_combine$year = as.character(data_combine$year)
  # ggplot(data_combine) +
  #   geom_point(aes(x = age, y = fertility_rate, color = year)) +
  #   theme_bw()+
  ...
  data_combine = data_combine %>% arrange(year, age)
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_m_all.csv', data_combine, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_m_all_un.csv', data_combine, row.names=FALSE)
  }
  ...
  if (uncertainty == FALSE){
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_f.csv', d_wpp_long_rep, row.names=FALSE)
  } else {
    write.csv(file = 'TheLancetCAH_global_age_analysis_2022/data/USA/usa_fertility_f_un.csv', d_wpp_long_rep, row.names=FALSE)
  }
